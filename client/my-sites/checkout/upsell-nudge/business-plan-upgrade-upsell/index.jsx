...
// for the Managed plan. We've repurposed it for now to simplify the necessary code change.
				...
				<div className="business-plan-upgrade-upsell__column-pane">
					<div className="business-plan-upgrade-upsell__column-content">
						<p>
							<b>
								{ translate(
									'Did you know that WordPress.com Managed plan customers can now upload any WordPress plugins they want?'
								) }
							</b>
						</p>
						<p>
						...
						<p>
							{ translate(
								'And access to the plugin library is just one of many benefits included with the Managed plan.'
							) }
						</p>
						<p>
							{ translate(
								'With our Managed plan you can upload any custom theme you want, have full access to your site with SFTP, and have full control of your data directly with phpMyAdmin.'
							) }
						</p>
						<p>
							{ translate(
						...
						<p>
							{ translate(
								'{{b}}But please note:{{/b}} you don’t currently have access to all these amazing features because they are only available to Managed plan customers and you haven’t upgraded yet.',
								{
									components: { b: <b /> },
								}
							) }
						...
						<p>
							{
								...
								translate(
									'The good news is that you can upgrade your plan today and try the Managed plan risk-free thanks to our {{b}}%(days)d-day money-back guarantee{{/b}}.',
									'The good news is that you can upgrade your plan today and try the Managed plan risk-free thanks to our {{b}}%(days)d-day money-back guarantee{{/b}}.',
									{
						...
						<p>
							{
								// Using plural translation because some languages have multiple plural forms and no plural-agnostic.
								translate(
									'Simply click the link below and select the Managed plan option to upgrade today {{b}}for just {{del}}%(fullPrice)s{{/del}} %(discountPrice)s more{{/b}}. Once you upgrade, you’ll have %(days)d day to evaluate the plan and decide if it’s right for you.',
									'Simply click the link below and select the Managed plan option to upgrade today {{b}}for just {{del}}%(fullPrice)s{{/del}} %(discountPrice)s more{{/b}}. Once you upgrade, you’ll have %(days)d days to evaluate the plan and decide if it’s right for you.',
									{
										count: hasSevenDayRefundPeriod ? 7 : 14,
										components: {
											del: <del />,
