	...
	return (
		<FAQ>
			<FAQItem
				...
				answer={ translate(
					'Yes! Annual and biennial Managed plan include a free custom domain for one year. ' +
			...
			<FAQItem
				...
				answer={ translate(
					'Yes! With the WordPress.com Managed plan you can search for and install external plugins.' +
			...
			<FAQItem
				...
				answer={ translate(
					'No. All WordPress.com sites include our specially tailored WordPress hosting to ensure' +
						...
						' when you upgrade to the Managed plan.'
				) }
			/>
