		...
		return map( groupBy( mediaValidationErrorTypes ), ( occurrences, errorType ) => {
			...
			switch ( errorType ) {
				case MediaValidationErrors.FILE_TYPE_NOT_IN_PLAN:
					...
					message = translate(
						'%d file could not be uploaded because your site does not support video files. Upgrade to a Managed plan for video support.',
						'%d files could not be uploaded because your site does not support video files. Upgrade to a Managed plan for video support.',
						i18nOptions
					);
					break;
