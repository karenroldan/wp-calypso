			...
			<div className="tools__feature-list">
				...
				{ getLocaleSlug() === 'en' && (
					<MarketingToolsFeature
						...
						description={ translate(
							'Discover an easy way to advertise your brand across Facebook and Instagram. Capture website actions to help you target audiences and measure results. {{em}}Available on Managed plan{{/em}}.',
							{
								components: {
									em: <em />,
								},
