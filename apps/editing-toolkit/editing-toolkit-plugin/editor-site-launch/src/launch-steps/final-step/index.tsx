					...
					<Tip>
						{ createInterpolateElement(
							sprintf(
								...
								__(
									'<Link>Upgrade to Managed</Link> to get access to plugins, premium themes, 50GB storage space, payment collection options, 24/7 Live Chat support, and more. Not sure? Give it a spin—we offer %1$d-day full-refunds, guaranteed.',
									'full-site-editing'
								),
								14
							),
